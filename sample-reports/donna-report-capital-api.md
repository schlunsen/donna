...
1. **Register a user account to obtain JWT token:**
    ...
    Response includes JWT token: `eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.<REDACTED>`
...
1. **Obtain Authentication Token via User Registration:**
    ...
    **Response:** JWT token in response body: `eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.<REDACTED>`
...
2. **Extract JWT token from registration response:**
    ...
    ```
    Token: eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.<REDACTED>
